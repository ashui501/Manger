...
def Mukesh_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "mukesh_":
        ...
        query.message.edit_text(f"*ʜᴇʏ,*🥀\n  *ᴛʜɪs ɪs {dispatcher.bot.first_name}*"
            "\n*I ᴀᴍ Kᴀᴋᴀsʜɪ Hᴀᴛᴀᴋᴇ ᴛʜᴇ ᴘᴏᴡᴇʀғᴜʟ ʙᴏᴛ ᴛᴏ ᴍᴀɴɢᴇ ɢʀᴏᴜᴘs ᴄʜᴇᴄᴋ /ʜᴇʟᴘ ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ*"
...
ꜱᴇᴛ ᴀ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇꜱꜱᴀɢᴇ!""",parse_mode=ParseMode.MARKDOWN,
        ...
        query.message.edit_text("""Well Like I said I am free for all 
""",parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [ [
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](Hola I can't give you my source kindly sorry)
...
""", 
        ...
        first_name = update.effective_user.first_name
        query.message.edit_text(
            PM_START_TEXT.format(escape_markdown(first_name),PM_IMG,BOT_NAME,sql.num_users(),sql.num_chats()),
            reply_markup=InlineKeyboardMarkup(buttons),
            parse_mode=ParseMode.MARKDOWN,
            timeout=60,
            disable_web_page_preview=True,
    ...
    x=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text=" 🥷 𝗦𝘂𝗺𝗺𝗼𝗻 𝗺𝗲 🥷",
                            url="https://t.me/Itachi_king_robot?startgroup=true"
                            )
                       ]
                ]
                     )
